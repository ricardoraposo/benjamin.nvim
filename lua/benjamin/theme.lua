...
theme.set_hl = function()
	...
	hl("Comment", { bg = "NONE", fg = p.comment_gray, style = "italic" })
	hl("SpecialComement", { bg = "NONE", fg = p.orange, style = "italic" })
	...
	hl("PMenuSel", { bg = "NONE", fg = p.yellow })
	...
	hl("Directory", { fg = p.yellow, bg = "NONE" })
